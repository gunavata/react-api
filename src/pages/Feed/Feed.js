...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch('https://rest-api-nodejspractice.herokuapp.com/graphql', {
      method: 'POST',
      headers: {
  ...
  finishEditHandler = postData => {
    ...
    fetch('https://rest-api-nodejspractice.herokuapp.com/post-image', {
        method: 'PUT',
        headers: {
          Authorization: 'Bearer ' + this.props.token,
        },
      ...
      .then(res => res.json())
      .then(fileResData => {
        console.log('start of create' + fileResData.errors)
        ...
        console.log('beforefetching    ' + fileResData.errors)
        return fetch('https://rest-api-nodejspractice.herokuapp.com/graphql', {
          method: 'POST',
          headers: {
            Authorization: 'Bearer ' + this.props.token,
            'Content-Type': 'application/json'
      ...
      .then(res => {
        console.log('after fetching   ' + res.errors)
        return res.json();
      })
      .then(resData => {
